<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:97:"D:\phpStudy\PHPTutorial\WWW\mall\public/../application/home\view\default\member\member\index.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\base_member.html";i:1545196757;s:81:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_top.html";i:1545811969;s:86:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\member_header.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\member_left.html";i:1545196757;s:85:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\member_items.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_server.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_footer.html";i:1545196757;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="dsm-container">
    ...
    <div class="dsm-sidebar">
        ...
        <div class="dl">
            <div class="dt">
                <h3 key="<?php echo $menu['name']; ?>"><i class="fa member_fa_<?php echo $menu['name']; ?>"></i><?php echo $menu['text']; ?></h3>
            </div>
            <div class="dd">
                <ul>
...
<div class="mc-left">
    <div class='mc-user'>
        <div class="mc-user-card fl">
            ...
            <div class="user-head fl">
                <div class="user-canvas "> 
                    <span><?php echo $home_member_info['level_name']; ?></span>
                    <div class="canvas-bg">
                ...
                <p class="user-img">
                    <img src="<?php echo get_member_avatar($home_member_info['member_avatar']); ?>">
                </p>
            </div>
            <div class="mc-user-info fl ">
                <div class="name"><?php echo $home_member_info['member_name']; ?></div>
                <a href="<?php echo url('membermessage/message'); ?>" class="link"><?php echo \think\Lang::get('ds_view'); ?><?php echo \think\Lang::get('ds_my_news'); ?>&nbsp;&gt;</a>
                <a href="<?php echo url('memberinformation/index'); ?>" class="mc-user-btn"><?php echo \think\Lang::get('ds_account_information'); ?></a>
            </div>
        </div>
        ...
        <div class="mc-user-huaban fl">
            <ul>
                <li>
                    <a href="<?php echo url('memberpoints/index'); ?>" class="p-icon fa fa-star-half-o"></a>
                    <p class="p-dec"><?php echo \think\Lang::get('bonus_point'); ?></p>
                    <p class="p-price"><span class=""><?php echo $home_member_info['member_points']; ?></span><?php echo \think\Lang::get('credit_unit'); ?></p>
                </li>
                <li>
                    <a href="<?php echo url('membervoucher/index'); ?>" class="p-icon fa fa-ticket"></a>
                    <p class="p-dec"><?php echo \think\Lang::get('voucher'); ?></p>
                    <p class="p-price"><span><?php echo $home_member_info['voucher_count']; ?></span><?php echo \think\Lang::get('zhang'); ?></p>
                </li>
                <li>
                    <a href="<?php echo url('predeposit/pd_log_list'); ?>" class="p-icon fa fa-credit-card"></a>
                    <p class="p-dec"><?php echo \think\Lang::get('ds_member_path_predeposit_title'); ?></p>
                    <p class="p-price"><span class=""><?php echo $home_member_info['available_predeposit']; ?></span><?php echo \think\Lang::get('ds_yuan'); ?></p>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="mc-order-portal">
        <ul>
            <li class="portal-icon-1">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_new']); ?>"><span class="fa fa-money"><?php if($home_order_info['order_nopay_count']): ?><b><?php echo $home_order_info['order_nopay_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_nopay'); ?></a>
            </li>
            <li class="portal-icon-5">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_pay']); ?>"><span class="fa fa-trello"><?php if($home_order_info['order_noship_count']): ?><b><?php echo $home_order_info['order_noship_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noship'); ?></a>
            </li>
            <li class="portal-icon-2">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_send']); ?>"><span class="fa fa-truck"><?php if($home_order_info['order_noreceipt_count']): ?><b><?php echo $home_order_info['order_noreceipt_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noreceipt'); ?></a>
            </li>
            <li class="portal-icon-3">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_noeval']); ?>"><span class="fa fa-commenting-o"><?php if($home_order_info['order_noeval_count']): ?><b><?php echo $home_order_info['order_noeval_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noeval'); ?></a>
            </li>
            <li class="portal-icon-4">
                <a href="<?php echo url('memberrefund/index'); ?>"><span class="fa fa-refresh"><?php if($home_order_info['order_refund_count']): ?><b><?php echo $home_order_info['order_refund_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_refund'); ?><?php echo \think\Lang::get('order_refund'); ?></a>
            </li>
...
<div class="mc-right">
    <div class="mc-security">
        <div class="title"><?php echo \think\Lang::get('account_security'); ?></div>
        <div class="content"><?php if($home_member_info['security_level']>2): ?><?php echo \think\Lang::get('high'); elseif($home_member_info['security_level']>1): ?><?php echo \think\Lang::get('medium'); else: ?><?php echo \think\Lang::get('low'); endif; ?></div>
        <div class="detail"><span class="fa fa-mobile"></span><?php echo \think\Lang::get('bind_mobile_phone'); ?><span class="state fr <?php if($home_member_info['member_mobilebind'] == 1): ?>active<?php endif; ?>"><?php if($home_member_info['member_mobilebind'] == 1): ?><?php echo \think\Lang::get('bound'); else: ?><?php echo \think\Lang::get('unbound'); endif; ?></span></div>
        <div class="detail"><span class="fa fa-envelope-o"></span><?php echo \think\Lang::get('bind_mailbox'); ?><span class="state fr <?php if($home_member_info['member_emailbind'] == 1): ?>active<?php endif; ?>"><?php if($home_member_info['member_emailbind'] == 1): ?><?php echo \think\Lang::get('bound'); else: ?><?php echo \think\Lang::get('unbound'); endif; ?></span></div>
    </div>
</div>   
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5c79531b3a94b = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5c79531b3a94b)==0 ) : echo "" ;else: foreach($_5c79531b3a94b as $key=>$art): ?>
        <dl> 
