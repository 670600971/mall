<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:94:"D:\phpStudy\PHPTutorial\WWW\mall\public/../application/home\view\default\mall\index\index.html";i:1545196757;s:82:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\base_home.html";i:1545196757;s:81:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_top.html";i:1545811969;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_header.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_server.html";i:1545196757;s:84:"D:\phpStudy\PHPTutorial\WWW\mall\application\home\view\default\base\mall_footer.html";i:1545196757;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="home-focus-layout">
    <div class="bd">
        <ul>
            <?php $ap_id =1;$ad_position = db("advposition")->cache(3600)->column("ap_id,ap_name,ap_width,ap_height","ap_id");$result = db("adv")->where("ap_id=$ap_id  and adv_enabled = 1 and adv_startdate < 1551452400 and adv_enddate > 1551452400 ")->order("adv_sort desc")->cache(3600)->limit("10")->select();
...
<div class="home-scroll w1200 mt10">
    <div class="bd">
        <ul>
            <li>
                <?php $ap_id =2;$ad_position = db("advposition")->cache(3600)->column("ap_id,ap_name,ap_width,ap_height","ap_id");$result = db("adv")->where("ap_id=$ap_id  and adv_enabled = 1 and adv_startdate < 1551452400 and adv_enddate > 1551452400 ")->order("adv_sort desc")->cache(3600)->limit("10")->select();
if(!in_array($ap_id,array_keys($ad_position)) && $ap_id)
{
  db("advposition")->insert(array(
         "ap_id"=>$ap_id,
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5c7952988e4fd = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5c7952988e4fd)==0 ) : echo "" ;else: foreach($_5c7952988e4fd as $key=>$art): ?>
        <dl> 
