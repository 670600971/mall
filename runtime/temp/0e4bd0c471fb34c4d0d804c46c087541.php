<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"D:\phpStudy\PHPTutorial\WWW\mall\public/../application/home\view\default\member\member\order_info.html";i:1545196757;}*/ ?>
<div class="pt20">
        <div class="mc-title">
        ...
        <div class="goods-rolling relative" id="mc-rolling-history">
            ...
            <div class="grid-btn btn-prev"><span class="fa fa-angle-left"></span></div>
            <div class="grid-btn btn-next"><span class="fa fa-angle-right"></span></div>
            <?php else: ?>
            <dl class="null-tip pt20 pb20">
                <dt class="fa fa-shopping-cart"></dt>
              <dd>
...
//信息轮换
    $.getScript("<?php echo PLUGINS_SITE_ROOT; ?>/jquery.SuperSlide.2.1.1.js", function() {
        jQuery('#mc-rolling-history').slide({mainCell:".goods-rolling",effect:"left",prevCell:".btn-prev",nextCell:".btn-next",autoPlay:true,vis:4});
    });
</script>
<?php endif; ?>
